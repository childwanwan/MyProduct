...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/searchBooksSell" method="post">
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								...
								<input
									type="submit" id="search" name="search" value="查询"
	...
	<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="18%">销售数量</td>
								
							</tr>

			<c:forEach items="${sell }" var="b">							
